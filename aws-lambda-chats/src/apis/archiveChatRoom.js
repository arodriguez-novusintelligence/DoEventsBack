...
exports.handler = async (event) => {
  ...
  try {
    ...
    const archivedBy = Array.isArray(room.archivedBy) ? [...room.archivedBy] : [];
    ...
    return jsonResponse(200, { message: "Chat archivado", roomId, archivedBy });
  } catch (error) {
    console.error("archiveChatRoom:", error);
