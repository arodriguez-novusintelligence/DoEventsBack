/**
 * Crea la tabla DynamoDB VenuePromoCodes-dev (single-table design por venue).
 * Uso: node scripts/create-venue-promo-codes-table.js
 */
const AWS = require('aws-sdk');

const region = process.env.AWS_REGION || process.env.DYNAMODB_REGION || 'sa-east-1';
const tableName = process.env.VENUE_PROMO_CODES_TABLE || 'VenuePromoCodes-dev';
