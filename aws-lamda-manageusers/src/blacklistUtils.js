...
const BACKOFFICE_REGION = process.env.BACKOFFICE_REGION || process.env.AWS_REGION || 'us-east-2';

const AWS = require('aws-sdk');
const backofficeDynamo = new AWS.DynamoDB.DocumentClient({ region: BACKOFFICE_REGION });

const BLOCKED_MESSAGE =
  'Esta cuenta no puede registrarse en do.events. Si crees que es un error, contacta a soporte.';
...
/**
 * Consulta lista negra del backoffice (BLACKLIST#email) y cuentas bloqueadas en Client.
 */
