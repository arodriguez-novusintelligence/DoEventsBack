...
$payload = @{
    ...
    tickets = @(
        @{
            ticketInstanceId = "01197ce3-a4b9-4c4c-8ba9-82c75eb0b224"
...
try {
    ...
    Write-Host "`n✅ Orden creada: $orderId" -ForegroundColor Green
    Write-Host "`n📋 Consultando orden para verificar color y gate..." -ForegroundColor Cyan
